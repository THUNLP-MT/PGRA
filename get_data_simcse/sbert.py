...
class SentRetriever(object):
    def __init__(
        self,
        output_sents_file="./wiki1m.simcse.features",
        all_sents=[], 
        s_bert="./huggingface/unsup-simcse-bert-base-uncased/"
        ):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sbert', type=str, default="./huggingface/unsup-simcse-bert-base-uncased/")
