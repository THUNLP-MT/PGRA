...
class Options():
    ...
    def add_reader_options(self):
        self.parser.add_argument('--tasks', type=str, default='cola', help='task')
        self.parser.add_argument('--train_data', type=str, default='get_data_bert/get_data/cola.train.json', help='path of train data')
        self.parser.add_argument('--eval_data', type=str, default='get_data_bert/cola.dev.json', help='path of eval data')
        self.parser.add_argument('--test_data', type=str, default='get_data_bert/cola.dev.json', help='path of test data')
        ...
        self.parser.add_argument('--n_context', type=int, default=20)
        self.parser.add_argument('--model_checkpoint', default=None, type=str)
    ...
    def add_retriever_options(self):
        ...
        self.parser.add_argument('--test_data', type=str, default='none', help='path of eval data')
    ...
    def initialize_parser(self):
        # basic parameters
        self.parser.add_argument('--name', type=str, default='experiment_cola', help='name of the experiment')
    ...
    def print_options(self, opt):
        ...
        expr_dir = Path(opt.checkpoint_dir)/ (opt.name + '_lr' + str(opt.lr) + '_bsz' + str(opt.per_gpu_batch_size) + '_steps' + str(opt.total_steps) + '_k' + str(opt.n_context))
